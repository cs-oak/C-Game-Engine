...
public:
  ...
  void setLockX() { velocityX(0); }
  void setLockY() { velocityY(0); }
  ...
  virtual void reset() {
    throw std::string("No reset");  
  }

  virtual bool isDrw() const {
    throw std::string("No isDrw");  
  }

  virtual bool followX(const Drawable*) {
    throw std::string("No followx");  
  }

  virtual bool followY(const Drawable*) {
    throw std::string("No followy");  
  }
